...
void main() {
  group('AuthToken validation', () {
    ...
    test('Valid token should return true', () async {
      // Token with an expiration time in the future (e.g., Dec 31, 2028)
      const validToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE4MzAyOTc2MDB9.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c';
